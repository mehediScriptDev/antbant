...
import { AlertTriangle, ShieldAlert, Scale, Gavel, ArrowRight, CheckCircle, Search, FileWarning, EyeOff } from "lucide-react";
  ...
  const laws = [
    {
      ...
      description: "Strict regulations implemented by the University Grants Commission of Bangladesh making ragging a punishable offense."
    },
    {
      icon: <Gavel className="w-8 h-8 text-white" />,
      title: "Criminal Offense",
      description: "Severe cases of physical or mental harassment are prosecutable under the Penal Code of Bangladesh."
    },
    {
      icon: <ShieldAlert className="w-8 h-8 text-white" />,
      title: "Zero Tolerance Policy",
      description: "Immediate suspension and potential expulsion for any student found guilty of organizing or participating in ragging."
    }
  ];
    ...
    <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-white leading-tight mb-6 uppercase tracking-tight">
              Ragging is a <span className="text-red-600">Crime.</span><br />
              Report it Now.
            </h1>
            
            <p className="text-xl text-slate-300 mb-10 leading-relaxed font-medium">
              This is the official, secure, and 100% anonymous portal for students in Bangladesh to report incidents of ragging, harassment, and bullying directly to the University Grants Commission and Law Enforcement.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2">
              <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">What Constitutes Ragging?</h2>
              <div className="h-1 w-20 bg-red-600 mb-8"></div>
              <p className="text-lg text-slate-700 mb-6 leading-relaxed font-medium">
                According to the Honorable Supreme Court and UGC Guidelines, ragging constitutes one or more of any of the following acts:
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3 bg-slate-50 p-4 border-l-4 border-red-600 rounded-sm">
                  <span className="text-slate-800 font-semibold">Any conduct by any student or students whether by words spoken or written or by an act which has the effect of teasing, treating or handling with rudeness a fresher or any other student.</span>
                </li>
                <li className="flex items-start gap-3 bg-slate-50 p-4 border-l-4 border-red-600 rounded-sm">
                  <span className="text-slate-800 font-semibold">Indulging in rowdy or undisciplined activities causing annoyance, hardship, physical or psychological harm or to raise fear or apprehension.</span>
                </li>
                <li className="flex items-start gap-3 bg-slate-50 p-4 border-l-4 border-red-600 rounded-sm">
                  <span className="text-slate-800 font-semibold">Asking any student to do any act which such student will not in the ordinary course do and which has the effect of causing or generating a sense of shame, or torment.</span>
                </li>
              </ul>
            </div>
            
            <div className="w-full lg:w-1/2 bg-slate-900 p-10 rounded-sm text-white">
              <h2 className="text-2xl font-black mb-8 uppercase tracking-tight text-red-500">Legal Framework & Consequences</h2>
      ...
      <section className="py-20 bg-slate-100 border-t border-slate-200">
        <div className="container mx-auto px-4 lg:px-8 text-center max-w-4xl">
          <h2 className="text-3xl font-black text-slate-900 mb-6 uppercase tracking-tight">How The Reporting Process Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 border-t-4 border-slate-800 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">File Complaint</h3>
              <p className="text-slate-600">Submit your incident details securely. You will receive a unique Tracking ID.</p>
            </div>
            <div className="bg-white p-8 border-t-4 border-red-600 shadow-sm relative transform md:-translate-y-4">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Investigation</h3>
              <p className="text-slate-600">The UGC Anti-Ragging Cell and University Authority are immediately notified to take action.</p>
            </div>
            <div className="bg-white p-8 border-t-4 border-slate-800 shadow-sm">
              ...
              <p className="text-slate-600">Strict disciplinary action is taken against the perpetrators. You can track progress anytime.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-red-700 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <h2 className="text-4xl font-black mb-6 uppercase tracking-tight">Don't Suffer in Silence.</h2>
          <p className="text-xl mb-10 text-red-100 max-w-2xl mx-auto font-medium">
            Your identity is safe. The law is on your side. Step forward to stop ragging in your university today.
          </p>
          <Link 
            href="/report" 
