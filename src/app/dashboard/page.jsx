      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Enter your secure tracking ID to check the real-time status of your
            report.
          </p>
        </div>
        ...
        <form onSubmit={handleSearch} className="mb-12">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              type="submit"
              className="px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-xl font-bold transition-colors shadow-lg shadow-primary-500/20 whitespace-nowrap"
            >
              Track Status
            </button>
          </div>
        ...
        {searched && (
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden animate-fade-in-up">
            ...
            <div className="p-8">
              ...
              <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:ml-5 md:before:translate-x-0 before:h-full before:w-0.5 before:bg-slate-200 dark:before:bg-slate-700">
                {/* Timeline Item 1 */}
                <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm ml-4 md:ml-0 text-left">
                    ...
                    <div className="text-slate-500 dark:text-slate-400 text-sm">
                      The university anti-ragging cell has assigned an
                      investigating officer to your case.
                    </div>
                  </div>
                </div>
                ...
                <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm ml-4 md:ml-0 text-left">
                    ...
                    <div className="text-slate-500 dark:text-slate-400 text-sm">
                      Initial review completed. Evidence has been verified and
                      securely stored.
                    </div>
                  </div>
                </div>
                ...
                <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm ml-4 md:ml-0 text-left">
                    ...
                    <div className="text-slate-500 dark:text-slate-400 text-sm">
                      Your anonymous report was successfully received by the
                      system.
                    </div>
                  </div>
                </div>
            ...
            <div className="p-6 bg-blue-50 dark:bg-blue-900/10 border-t border-blue-100 dark:border-blue-900">
              <p className="text-sm text-blue-800 dark:text-blue-300">
                <strong>Need immediate assistance?</strong> If you feel unsafe,
                please click the SOS Panic button or call the national emergency
                hotline at 999. You can also request a confidential counselling
                session from this dashboard.
              </p>
            </div>
          </div>
        )}
