...
export default function CasesPage() {
  ...
  const recentActions = [
    {
      ...
      action:
        "3 students permanently expelled, 5 suspended for 2 semesters.",
    ...
    },
    {
      ...
      action:
        "Cyber Security Act filed against 2 students for online intimidation.",
    ...
    },
    {
      ...
      action:
        "Hall allocation cancelled for 12 students involved in midnight ragging.",
    ...
    },
    {
      ...
      action:
        "Strict disciplinary warning and mandatory counseling for 4 seniors.",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      {/* Hero Section */}
      <section className="bg-slate-900 pt-20 pb-20 border-b-4 border-red-600">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className={`bg-slate-50 p-8 rounded-sm shadow-sm border-t-4 ${stat.color} text-center`}
              >
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          ...
          <div className="space-y-6">
            {recentActions.map((action, index) => (
              <div
                key={index}
                className="bg-white border-l-4 border-red-600 p-6 md:p-8 rounded-sm shadow-sm"
              >
                ...
                <h4 className="text-red-600 font-bold uppercase tracking-wide text-sm mb-2">
                  {t.casesOffense}: {action.category}
                </h4>
                <p className="text-slate-700 text-lg font-medium leading-relaxed">
                  <strong>{t.casesActionTaken}:</strong> {action.action}
                </p>
              </div>
            ))}
          </div>
